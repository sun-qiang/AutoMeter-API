...
public interface DispatchMapper extends MyMapper<Dispatch> {
    ...
    void updatedispatchstatusandmemobyname(@Param("status") String status,@Param("memo") String memo,@Param("slaverid")Long slaverid,@Param("execplanid")Long execplanid,@Param("batchname")String batchname,@Param("testcaseid")Long testcaseid);
