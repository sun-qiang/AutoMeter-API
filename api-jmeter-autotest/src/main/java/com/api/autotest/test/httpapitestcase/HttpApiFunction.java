...
public class HttpApiFunction extends AbstractJavaSamplerClient {
    ...
    public void teardownTest(JavaSamplerContext ctx) {
        ...
        try {
            ...
            getLogger().info("UpdateSlaverStatus1 。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。:" + exception.getMessage());
        }
    ...
    public static void main(String[] args) {
        Arguments params = new Arguments();
        params.addArgument("planid", "7");
        params.addArgument("batchname", "mail0002");
        params.addArgument("DispatchIds", "12,");
