<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :show-overflow-tooltip="true"  label="随机变量名" align="center" prop="variablesname" width="180"/>
      ...
      <el-table-column :show-overflow-tooltip="true"  label="随机描述" align="center" prop="memo" width="150"/>
