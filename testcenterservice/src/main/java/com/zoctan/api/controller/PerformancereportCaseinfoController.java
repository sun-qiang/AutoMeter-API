...
public class PerformancereportCaseinfoController {
    ...
    @PutMapping("/detail")
    public Result updateDeploy(@RequestBody final PerformancereportCaseinfo recipe) {
        performancereportCaseinfoService.updateDic(recipe);
        return ResultGenerator.genOkResult();
    }
    ...
    public Result search(@RequestBody final Map<String, Object> param) {
        ...
        PageHelper.startPage(page, size);
        final List<PerformancereportCaseinfo> list = performancereportCaseinfoService.findDicWithName(param);
        final PageInfo<PerformancereportCaseinfo> pageInfo = new PageInfo<>(list);
        return ResultGenerator.genOkResult(pageInfo);
    }
}
